...
if ( ! function_exists( 'action_scheduler_register_1_dot_5_dot_1' ) ) {
	...
	add_action( 'plugins_loaded', 'action_scheduler_register_1_dot_5_dot_1', 0, 0 );

	function action_scheduler_register_1_dot_5_dot_1() {

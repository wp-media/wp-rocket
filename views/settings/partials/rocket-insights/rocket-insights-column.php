...
if ( null === $data['wpr_rocket_row'] ) :
	?>
	<div class="wpr-ri-column wpr-ri-not-tracked" data-url="<?php echo esc_attr( $data['wpr_rocket_insights_url'] ); ?>" data-is-free="<?php echo esc_attr( $data['wpr_is_free'] ? '1' : '0' ); ?>">

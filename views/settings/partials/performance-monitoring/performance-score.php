...
<div class="wpr-percentage-indicator">
	...
	<?php else : ?>
		<?php echo $rocket_opening_anchor_tag; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
			<div class="wpr-percentage-circle <?php echo esc_html( $data['status-color'] ?? '' ); ?> <?php echo $rocket_pma_item_is_blurred ? 'blurred' : ''; echo 100 === $data['score'] ? 'wpr-centralize-100-score' : '' ?>">

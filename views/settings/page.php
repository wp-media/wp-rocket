	...
	<div class="wpr-Popin wpr-Popin-Analytics">
		...
		<div class="wpr-Popin-content">
			...
			<div class="wpr-Popin-flex">
				...
				<div>
					<button class="wpr-button wpr-button--small wpr-button--icon wpr-icon-check wpr-button--blue wpr-rocket-analytics-cta<?php echo get_option( 'rocket_mixpanel_optin' ) ? ' wpr-isHidden' : ''; ?>"><?php esc_html_e( 'Activate Rocket analytics', 'rocket' ); ?></button>
				</div>
			</div>
		</div>
	</div>

...
<?php endif; ?>
<div class="wpr-field wpr-field--text wpr-field--number wpr-field--split">
	<div class="wpr-text wpr-text--number">
		...
		<input type="number" id="purge_cron_interval" name="wp_rocket_settings[purge_cron_interval]" value="<?php echo esc_attr( $purge_interval ); ?>">
	</div>
</div>
<div class="wpr-field wpr-field--select wpr-field--split">

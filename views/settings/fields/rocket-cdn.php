...
$cnames      = get_rocket_option( 'cdn_cnames' ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals
$cnames_zone = get_rocket_option( 'cdn_zone' ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals
?>
<div class="wpr-fieldsContainer-fieldset">
	<div class="wpr-field">
		...
		<?php
		if ( $cnames ) :
			foreach ( $cnames as $key => $url ) : // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
				?>
				<div class="wpr-text">

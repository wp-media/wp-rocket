<?php
/**
 * Textarea field with container template.
 *
 * @since 3.22
 *
 * @param array $data {
...
<div class="wpr-fieldsContainer <?php echo esc_attr( $data['class'] ); ?>">
	<fieldset class="wpr-fieldsContainer-fieldset">
		<div class="wpr-field wpr-field--textarea"<?php echo $data['parent']; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- $data['parent'] escaped with esc_attr. ?>>

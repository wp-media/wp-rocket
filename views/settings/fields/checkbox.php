...
<?php if ( ! empty( $data['warning'] ) ) : ?>
	<div class="wpr-fieldWarning">
		...
		<?php endif; ?>
		<button class="wpr-button wpr-button--small wpr-button--icon wpr-icon-check" data-url="<?php echo ( ! empty( $data['warning']['button_url'] ) ? esc_url( $data['warning']['button_url'] ) : '' ); ?>"><?php echo esc_html( $data['warning']['button_label'] ); ?></button>
	</div>
<?php endif; ?>

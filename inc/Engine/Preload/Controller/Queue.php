...
class Queue extends AbstractASQueue {
	...
	public function has_tasks_remain() {
		$parse_sitemap = $this->search(['hook' => 'rocket_preload_job_parse_sitemap', 'status' => ActionScheduler_Store::STATUS_PENDING], 'ids');
		$preload_url = $this->search(['hook' => 'rocket_preload_job_preload_url', 'status' => ActionScheduler_Store::STATUS_PENDING], 'ids');

...
class RUCSSQueueRunner extends ActionScheduler_Abstract_QueueRunner {
	 ...
	 */
	public function __construct( ActionScheduler_Store|null $store = null, ActionScheduler_FatalErrorMonitor|null $monitor = null, Cleaner|null $cleaner = null, ActionScheduler_AsyncRequest_QueueRunner|null $async_request = null ) {
		if ( is_null( $cleaner ) ) {
			/**

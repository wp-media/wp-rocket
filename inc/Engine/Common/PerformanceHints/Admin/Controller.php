	...
	public function truncate_from_admin( $clean ) {
		...
		return [
			...
			'message' => sprintf(
				...
				__( '%1$s: Stored optimization data for Critical Images, Lazy Rendered Content, Preconnect to External Domains, and Preload Fonts has been cleared. New data will be generated as needed.', 'rocket' ),

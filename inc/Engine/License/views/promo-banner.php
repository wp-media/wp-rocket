...
<div class="rocket-promo-banner" id="rocket-promo-banner">
	...
	<div class="rocket-promo-cta-block">
		...
		<ul class="rocket-promo-countdown" id="rocket-promo-countdown">
			<li class="item"><span class="value rocket-countdown-days"><?php echo esc_html( $data['countdown']['days'] ); ?></span> <?php esc_html_e( 'Days', 'rocket' ); ?></li>
			<li class="item"><span class="value rocket-countdown-hours"><?php echo esc_html( $data['countdown']['hours'] ); ?></span> <?php esc_html_e( 'Hours', 'rocket' ); ?></li>
			<li class="item"><span class="value rocket-countdown-minutes"><?php echo esc_html( $data['countdown']['minutes'] ); ?></span> <?php esc_html_e( 'Minutes', 'rocket' ); ?></li>
			<li class="item"><span class="value rocket-countdown-seconds"><?php echo esc_html( $data['countdown']['seconds'] ); ?></span> <?php esc_html_e( 'Seconds', 'rocket' ); ?></li>
		</ul>

...
?>
<div class="notice notice-alt notice-warning is-dismissible" id="rocketcdn-change-cname-notice">
	...
	<p><?php esc_html_e( 'C,', 'rocket' ); ?> <a href="<?php echo esc_url( $data['support_url'] ); ?>" target="_blank" rel="noopener" class="wpr-button" id="rocketcdn-change-cname-button"><?php esc_html_e( 'contact support', 'rocket' ); ?></a>.</p>
</div>

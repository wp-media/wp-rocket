...
namespace WP_Rocket\Engine\PerformanceMonitoring\Database\Queries;

use WP_Rocket\Dependencies\BerlinDB\Database\Query;

use WP_Rocket\Engine\PerformanceMonitoring\Database\Schemas\PerformanceMonitoring as PerformanceMonitoringSchema;

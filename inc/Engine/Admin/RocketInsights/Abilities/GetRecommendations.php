	...
	public function register(): void {
		...
		wp_register_ability(
			...
			[
				...
				'description'         => __( 'Returns the performance recommendations generated by WP Rocket\'s Rocket Insights for this site, so optimizations can be prioritized from WP Rocket\'s own analysis rather than generic advice. Takes no input. Returns an object with a "status" field — "loading" (recommendations are being fetched), "completed" (ready), "failed" (the last fetch failed), or "expired" (no cached data; the "recommendations" array is empty) — and a "recommendations" array. Each recommendation contains: "option_slug" (the related WP Rocket option), "title" and "description" (human-readable text), "mcp_actionable" (true when the recommendation can be applied automatically), and "mcp_ability" ("wp-rocket/set-option" when actionable, or null when the recommendation requires manual action). Use "mcp_actionable" to separate changes that can be applied via MCP from those needing manual steps.', 'rocket' ),

...
class Controller {
	...
	public function add_homepage() {
		 ...
		 */
		do_action( 'rocket_rocket_insights_job_added', home_url() );
	}
	...
	public function get_license_data(): array {
		...
		$data            = [
			...
			'page_number' => $limit,
			'period'      => 'month',
			'description' => $this->user->get_rocket_insights_addon_description( $upgrade ),
		...
		$data['promo_description']     = $this->user->get_rocket_insights_addon_promo_description( $upgrade );
		return $data;
	}

...
/**
 * Display Notice for incorrect Action Scheduler tables.
 *
 * @since 3.12.1
 *
 * @return void
 */
function rocket_notice_missed_table_as() {
...
add_action( 'admin_notices', 'rocket_notice_missed_table_as' );

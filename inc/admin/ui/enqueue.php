...
function rocket_add_admin_css_js() {
	...
	wp_enqueue_style( 'wpr-admin-style', WP_ROCKET_ASSETS_CSS_URL . 'wpr-admin.css', null, WP_ROCKET_VERSION );
	wp_enqueue_script( 'wpr-admin-js', WP_ROCKET_ASSETS_JS_URL . 'wpr-admin.js', null, WP_ROCKET_VERSION, true);
}

...
function rocket_cdn_custom_files( $html ) {
	...
	if ( $cnames = get_rocket_cdn_cnames( $zone ) ) {
		 ...
		 */
		$filetypes = apply_filters( 'rocket_cdn_custom_filetypes', array( 'mp3', 'ogg', 'mp4', 'm4v', 'avi', 'mov', 'flv', 'swf', 'webm', 'pdf', 'doc', 'docx', 'txt', 'zip', 'tar', 'bz2', 'tgz', 'rar', 'jpg', 'jpeg', 'png', 'gif', 'webp', 'bmp', 'tiff' ) );

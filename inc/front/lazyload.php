...
function rocket_lazyload_script() {
	...
	echo '<script type="text/javascript">!function(t,e){function a(){t._dE=/WebKit/.test(navigator.userAgent)?e.body:e.documentElement,o()}function n(t){var e=t.getBoundingClientRect();return{top:e.top+_dE.scrollTop,left:e.left+_dE.scrollLeft}}function o(){for(var a="CSS1Compat"===e.compatMode?_dE.scrollTop:t.pageYOffset,o=t.innerHeight||_dE.clientHeight,r=e.querySelectorAll("[data-lazy-src],[data-lazy-original]"),l=0;l<r.length;l++){var i=r[l];if("img"==i.tagName.toLowerCase()){var d=n(i).top;if(o+a>d){var c=i.getAttribute("data-lazy-original")?"data-lazy-original":"data-lazy-src",g=i.getAttribute(c);i.src=g,i.removeAttribute(c)}}}}t.addEventListener?(t.addEventListener("scroll",o,!1),t.addEventListener("load",a,!1)):t.attachEvent&&(t.attachEvent("onscroll",o),t.attachEvent("onload",a))}(window,document);</script>';
}
...
function __rocket_lazyload_replace_callback( $matches ) {
	...
	$data_atts_1_3 = array( 'data-no-lazy=', 'data-lazy-original=', 'data-lazy-src=', 'data-src=', 'data-bgposition=', 'data-envira-src=', 'fullurl=', 'lazy-slider-img=' );
	$data_atts_2 = array( '\/wpcf7_captcha\/', 'timthumb\.php\?src' );
	if ( preg_match( '/' . implode( '|', $data_atts_1_3 )  . '/i', $matches[1] . $matches[3] ) === 0 && preg_match( '/' . implode( '|', $data_atts_2 )  . '/i', $matches[2] ) ) {

...
class Critical_CSS_Subscriber implements Subscriber_Interface {
	...
	public function critical_css_generation_complete_notice() {
		...
		if ( 'error' === $status || 'warning' === $status ) {
			$message .= '<p><a href="https://docs.wp-rocket.me/article/108-render-blocking-javascript-and-css-pagespeed#errors" target="_blank" rel="noreferer noopener">' . __( 'More info about the errors', 'rocket' ) . '</a>';
		}

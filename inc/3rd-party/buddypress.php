 ...
 *
 * @since 2.8.15 Updated filter priority and removed check for profile
 * @since 2.6.9
 */
add_filter( 'do_rocket_lazyload', '__deactivate_rocket_lazyload_on_buddypress_profil_pages', 12 );

...
namespace WP_Rocket\Dependencies\Monolog\Formatter;

use Exception;
use WP_Rocket\Dependencies\Monolog\Utils;
...
class NormalizerFormatter implements FormatterInterface
{
    ...
    public function __construct($dateFormat = null, $maxDepth = 9)
    {
        ...
        if (!function_exists('json_encode')) {
            throw new \RuntimeException('PHP\'s json extension is required to use WP_Rocket\Dependencies\Monolog\'s NormalizerFormatter');
        }
    }

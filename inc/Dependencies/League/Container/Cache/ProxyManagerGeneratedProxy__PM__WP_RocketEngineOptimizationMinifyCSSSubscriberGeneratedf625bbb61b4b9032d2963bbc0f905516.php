...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Optimization\Minify\CSS\Subscriber;

class Generatedf625bbb61b4b9032d2963bbc0f905516 extends \WP_Rocket\Engine\Optimization\Minify\CSS\Subscriber implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Optimization\Minify\CSS\Subscriber|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signaturef625bbb61b4b9032d2963bbc0f905516 = '';
    ...
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'fix_ssl_minify', array('url' => $url), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->fix_ssl_minify($url);
    }

    public function i18n_multidomain_url($url)
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'i18n_multidomain_url', array('url' => $url), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->i18n_multidomain_url($url);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->options, $instance->processor, $instance->filesystem);
    ...
    public function __construct(\WP_Rocket\Admin\Options_Data $options, $filesystem)
    {
        static $reflection;

        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\Minify\\CSS\\Subscriber');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        unset($this->options, $this->processor, $this->filesystem);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\Minify\\CSS\\Subscriber');

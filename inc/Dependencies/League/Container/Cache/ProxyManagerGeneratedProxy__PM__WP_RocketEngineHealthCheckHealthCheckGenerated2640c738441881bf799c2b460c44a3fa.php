...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\HealthCheck\HealthCheck;

class Generated2640c738441881bf799c2b460c44a3fa extends \WP_Rocket\Engine\HealthCheck\HealthCheck implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\HealthCheck\HealthCheck|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature2640c738441881bf799c2b460c44a3fa = '';

    public function missed_cron()
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'missed_cron', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->missed_cron();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\WP_Rocket\Engine\HealthCheck\HealthCheck $instance) {
            unset($instance->options, $instance->events);
        }, $instance, 'WP_Rocket\\Engine\\HealthCheck\\HealthCheck')->__invoke($instance);
    ...
    public function __construct(\WP_Rocket\Admin\Options_Data $options)
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\HealthCheck\\HealthCheck');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\WP_Rocket\Engine\HealthCheck\HealthCheck $instance) {
            unset($instance->options, $instance->events);
        }, $this, 'WP_Rocket\\Engine\\HealthCheck\\HealthCheck')->__invoke($this);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\HealthCheck\\HealthCheck');

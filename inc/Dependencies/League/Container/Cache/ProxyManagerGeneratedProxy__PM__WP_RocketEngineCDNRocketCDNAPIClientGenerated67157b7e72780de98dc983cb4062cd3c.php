...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\CDN\RocketCDN\APIClient;

class Generated67157b7e72780de98dc983cb4062cd3c extends \WP_Rocket\Engine\CDN\RocketCDN\APIClient implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\CDN\RocketCDN\APIClient|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature67157b7e72780de98dc983cb4062cd3c = '';

    public function get_subscription_data()
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'get_subscription_data', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->get_subscription_data();
    }

    public function get_pricing_data()
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'get_pricing_data', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->get_pricing_data();
    }

    public function purge_cache_request()
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'purge_cache_request', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->purge_cache_request();
    }
    ...
    public function __construct()
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\CDN\\RocketCDN\\APIClient');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\CDN\\RocketCDN\\APIClient');

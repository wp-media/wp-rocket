...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\TestLazyload\TestClass;

class Generatedd9d9fe17849f2e172027ed2dff63d478 extends \WP_Rocket\Engine\TestLazyload\TestClass implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\TestLazyload\TestClass|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signatured9d9fe17849f2e172027ed2dff63d478 = '';

    public function test1()
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'test1', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->test1();
    }
    ...
    public function __construct()
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\TestLazyload\\TestClass');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\TestLazyload\\TestClass');

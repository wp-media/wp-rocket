...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Media\Emojis\EmojisSubscriber;

class Generated05fae8ace09f2a4ee340763e39ad11ca extends \WP_Rocket\Engine\Media\Emojis\EmojisSubscriber implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Media\Emojis\EmojisSubscriber|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature05fae8ace09f2a4ee340763e39ad11ca = '';

    public function disable_emoji()
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'disable_emoji', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->disable_emoji();
    }

    public function disable_emoji_tinymce($plugins)
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'disable_emoji_tinymce', array('plugins' => $plugins), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->disable_emoji_tinymce($plugins);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\WP_Rocket\Engine\Media\Emojis\EmojisSubscriber $instance) {
            unset($instance->options);
        }, $instance, 'WP_Rocket\\Engine\\Media\\Emojis\\EmojisSubscriber')->__invoke($instance);
    ...
    public function __construct(\WP_Rocket\Admin\Options_Data $options)
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Media\\Emojis\\EmojisSubscriber');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\WP_Rocket\Engine\Media\Emojis\EmojisSubscriber $instance) {
            unset($instance->options);
        }, $this, 'WP_Rocket\\Engine\\Media\\Emojis\\EmojisSubscriber')->__invoke($this);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Media\\Emojis\\EmojisSubscriber');

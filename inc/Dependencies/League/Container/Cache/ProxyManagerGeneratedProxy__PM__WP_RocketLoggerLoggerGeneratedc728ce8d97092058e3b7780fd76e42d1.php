...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Logger\Logger;

class Generatedc728ce8d97092058e3b7780fd76e42d1 extends \WP_Rocket\Logger\Logger implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Logger\Logger|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signaturec728ce8d97092058e3b7780fd76e42d1 = '';
    ...
    public function __construct()
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Logger\\Logger');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Logger\\Logger');

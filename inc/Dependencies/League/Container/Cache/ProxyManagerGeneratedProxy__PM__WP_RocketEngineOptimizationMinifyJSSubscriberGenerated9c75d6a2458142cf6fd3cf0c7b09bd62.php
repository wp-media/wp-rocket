...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Optimization\Minify\JS\Subscriber;

class Generated9c75d6a2458142cf6fd3cf0c7b09bd62 extends \WP_Rocket\Engine\Optimization\Minify\JS\Subscriber implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Optimization\Minify\JS\Subscriber|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature9c75d6a2458142cf6fd3cf0c7b09bd62 = '';
    ...
    public function __construct(\WP_Rocket\Admin\Options_Data $options, $filesystem)
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\Minify\\JS\\Subscriber');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\Minify\\JS\\Subscriber');

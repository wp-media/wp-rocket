...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\CriticalPath\APIClient;

class Generatedcf01d0e2012d9de3d42a97e218cace00 extends \WP_Rocket\Engine\CriticalPath\APIClient implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\CriticalPath\APIClient|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signaturecf01d0e2012d9de3d42a97e218cace00 = '';

    public function send_generation_request($url, $params = [], $item_type = 'custom')
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'send_generation_request', array('url' => $url, 'params' => $params, 'item_type' => $item_type), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->send_generation_request($url, $params, $item_type);
    }

    public function get_job_details($job_id, $url, $is_mobile = false, $item_type = 'custom')
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'get_job_details', array('job_id' => $job_id, 'url' => $url, 'is_mobile' => $is_mobile, 'item_type' => $item_type), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->get_job_details($job_id, $url, $is_mobile, $item_type);
    }
    ...
    public function __construct()
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\CriticalPath\\APIClient');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\CriticalPath\\APIClient');

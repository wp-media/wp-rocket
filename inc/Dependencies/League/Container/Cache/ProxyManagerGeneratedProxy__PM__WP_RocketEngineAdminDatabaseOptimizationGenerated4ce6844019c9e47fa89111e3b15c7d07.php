...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Admin\Database\Optimization;

class Generated4ce6844019c9e47fa89111e3b15c7d07 extends \WP_Rocket\Engine\Admin\Database\Optimization implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Admin\Database\Optimization|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature4ce6844019c9e47fa89111e3b15c7d07 = '';
    ...
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'process_handler', array('options' => $options), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->process_handler($options);
    }

    public function count_cleanup_items($type)
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'count_cleanup_items', array('type' => $type), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->count_cleanup_items($type);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->process);

        \Closure::bind(function (\WP_Rocket\Engine\Admin\Database\Optimization $instance) {
            unset($instance->options);
        }, $instance, 'WP_Rocket\\Engine\\Admin\\Database\\Optimization')->__invoke($instance);
    ...
    public function __construct(\WP_Rocket\Engine\Admin\Database\OptimizationProcess $process)
    {
        static $reflection;

        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Admin\\Database\\Optimization');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        unset($this->process);

        \Closure::bind(function (\WP_Rocket\Engine\Admin\Database\Optimization $instance) {
            unset($instance->options);
        }, $this, 'WP_Rocket\\Engine\\Admin\\Database\\Optimization')->__invoke($this);

        }

        $this->valueHolder5c912->__construct($process);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Admin\\Database\\Optimization');

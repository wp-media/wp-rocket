...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Optimization\DynamicLists\DelayJSLists\DataManager;

class Generated8c81319ab4e3edf0d7b244e581142099 extends \WP_Rocket\Engine\Optimization\DynamicLists\DelayJSLists\DataManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Optimization\DynamicLists\DelayJSLists\DataManager|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature8c81319ab4e3edf0d7b244e581142099 = '';
    ...
    public function __construct($filesystem = null)
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\DynamicLists\\DelayJSLists\\DataManager');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\DynamicLists\\DelayJSLists\\DataManager');

...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Optimization\DynamicLists\DefaultLists\APIClient;

class Generated730ee7d130e0206c44a6bc225ed7cb31 extends \WP_Rocket\Engine\Optimization\DynamicLists\DefaultLists\APIClient implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Optimization\DynamicLists\DefaultLists\APIClient|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature730ee7d130e0206c44a6bc225ed7cb31 = '';
    ...
    public function __construct(\WP_Rocket\Admin\Options_Data $options)
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\DynamicLists\\DefaultLists\\APIClient');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\DynamicLists\\DefaultLists\\APIClient');

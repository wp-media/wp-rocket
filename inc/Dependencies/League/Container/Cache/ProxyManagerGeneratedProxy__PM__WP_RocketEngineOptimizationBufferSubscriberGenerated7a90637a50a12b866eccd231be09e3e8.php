...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Optimization\Buffer\Subscriber;

class Generated7a90637a50a12b866eccd231be09e3e8 extends \WP_Rocket\Engine\Optimization\Buffer\Subscriber implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Optimization\Buffer\Subscriber|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature7a90637a50a12b866eccd231be09e3e8 = '';

    public function start_content_process()
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'start_content_process', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->start_content_process();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\WP_Rocket\Engine\Optimization\Buffer\Subscriber $instance) {
            unset($instance->optimizer);
        }, $instance, 'WP_Rocket\\Engine\\Optimization\\Buffer\\Subscriber')->__invoke($instance);
    ...
    public function __construct(\WP_Rocket\Engine\Optimization\Buffer\Optimization $optimizer)
    {
        static $reflection;

        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\Buffer\\Subscriber');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\WP_Rocket\Engine\Optimization\Buffer\Subscriber $instance) {
            unset($instance->optimizer);
        }, $this, 'WP_Rocket\\Engine\\Optimization\\Buffer\\Subscriber')->__invoke($this);

        }

        $this->valueHolder5c912->__construct($optimizer);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\Buffer\\Subscriber');

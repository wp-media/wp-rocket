...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\CDN\RocketCDN\CDNOptionsManager;

class Generated35a9fae7142cf9a8f4ece64e0414b38a extends \WP_Rocket\Engine\CDN\RocketCDN\CDNOptionsManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\CDN\RocketCDN\CDNOptionsManager|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature35a9fae7142cf9a8f4ece64e0414b38a = '';

    public function enable($cdn_url)
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'enable', array('cdn_url' => $cdn_url), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->enable($cdn_url);
    }
    ...
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'get_cdn_cnames', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->get_cdn_cnames();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\WP_Rocket\Engine\CDN\RocketCDN\CDNOptionsManager $instance) {
            unset($instance->options_api, $instance->options);
        }, $instance, 'WP_Rocket\\Engine\\CDN\\RocketCDN\\CDNOptionsManager')->__invoke($instance);
    ...
    public function __construct(\WP_Rocket\Admin\Options $options_api, \WP_Rocket\Admin\Options_Data $options)
    {
        static $reflection;

        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\CDN\\RocketCDN\\CDNOptionsManager');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\WP_Rocket\Engine\CDN\RocketCDN\CDNOptionsManager $instance) {
            unset($instance->options_api, $instance->options);
        }, $this, 'WP_Rocket\\Engine\\CDN\\RocketCDN\\CDNOptionsManager')->__invoke($this);

        }

        $this->valueHolder5c912->__construct($options_api, $options);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\CDN\\RocketCDN\\CDNOptionsManager');

...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Optimization\GoogleFonts\Combine;

class Generatedf792d9fa5e1d7e3a3c39e2e1304a0504 extends \WP_Rocket\Engine\Optimization\GoogleFonts\Combine implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Optimization\GoogleFonts\Combine|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signaturef792d9fa5e1d7e3a3c39e2e1304a0504 = '';
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->fonts, $instance->subsets, $instance->display_values, $instance->has_google_fonts);

        \Closure::bind(function (\WP_Rocket\Engine\Optimization\GoogleFonts\Combine $instance) {
            unset($instance->xmp_replace, $instance->html_replace, $instance->svg_replace);
        }, $instance, 'WP_Rocket\\Engine\\Optimization\\GoogleFonts\\Combine')->__invoke($instance);
    ...
    public function __construct()
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\GoogleFonts\\Combine');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        unset($this->fonts, $this->subsets, $this->display_values, $this->has_google_fonts);

        \Closure::bind(function (\WP_Rocket\Engine\Optimization\GoogleFonts\Combine $instance) {
            unset($instance->xmp_replace, $instance->html_replace, $instance->svg_replace);
        }, $this, 'WP_Rocket\\Engine\\Optimization\\GoogleFonts\\Combine')->__invoke($this);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\GoogleFonts\\Combine');

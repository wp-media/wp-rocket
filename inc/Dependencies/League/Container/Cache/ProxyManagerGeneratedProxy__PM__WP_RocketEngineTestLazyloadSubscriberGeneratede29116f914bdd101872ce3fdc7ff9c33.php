...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\TestLazyload\Subscriber;

class Generatede29116f914bdd101872ce3fdc7ff9c33 extends \WP_Rocket\Engine\TestLazyload\Subscriber implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\TestLazyload\Subscriber|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signaturee29116f914bdd101872ce3fdc7ff9c33 = '';

    public function log_message_in_dashboard_only()
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'log_message_in_dashboard_only', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->log_message_in_dashboard_only();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\WP_Rocket\Engine\TestLazyload\Subscriber $instance) {
            unset($instance->test_class);
        }, $instance, 'WP_Rocket\\Engine\\TestLazyload\\Subscriber')->__invoke($instance);
    ...
    public function __construct(\WP_Rocket\Engine\TestLazyload\TestClass $test_class)
    {
        static $reflection;

        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\TestLazyload\\Subscriber');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\WP_Rocket\Engine\TestLazyload\Subscriber $instance) {
            unset($instance->test_class);
        }, $this, 'WP_Rocket\\Engine\\TestLazyload\\Subscriber')->__invoke($this);

        }

        $this->valueHolder5c912->__construct($test_class);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\TestLazyload\\Subscriber');

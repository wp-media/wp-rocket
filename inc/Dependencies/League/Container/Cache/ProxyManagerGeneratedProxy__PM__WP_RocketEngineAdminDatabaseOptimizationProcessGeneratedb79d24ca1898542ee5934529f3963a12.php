...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Admin\Database\OptimizationProcess;

class Generatedb79d24ca1898542ee5934529f3963a12 extends \WP_Rocket\Engine\Admin\Database\OptimizationProcess implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Admin\Database\OptimizationProcess|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signatureb79d24ca1898542ee5934529f3963a12 = '';
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->prefix, $instance->action, $instance->count, $instance->start_time, $instance->cron_hook_identifier, $instance->cron_interval_identifier, $instance->identifier, $instance->data);
    ...
    public function __construct()
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Admin\\Database\\OptimizationProcess');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        unset($this->prefix, $this->action, $this->count, $this->start_time, $this->cron_hook_identifier, $this->cron_interval_identifier, $this->identifier, $this->data);

        }

        $this->valueHolder5c912->__construct();
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Admin\\Database\\OptimizationProcess');

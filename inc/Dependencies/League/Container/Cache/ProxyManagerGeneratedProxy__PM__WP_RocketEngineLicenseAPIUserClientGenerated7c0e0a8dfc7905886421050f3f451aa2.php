...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\License\API\UserClient;

class Generated7c0e0a8dfc7905886421050f3f451aa2 extends \WP_Rocket\Engine\License\API\UserClient implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\License\API\UserClient|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature7c0e0a8dfc7905886421050f3f451aa2 = '';

    public function get_user_data()
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'get_user_data', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->get_user_data();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\WP_Rocket\Engine\License\API\UserClient $instance) {
            unset($instance->options);
        }, $instance, 'WP_Rocket\\Engine\\License\\API\\UserClient')->__invoke($instance);
    ...
    public function __construct(\WP_Rocket\Admin\Options_Data $options)
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\License\\API\\UserClient');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\WP_Rocket\Engine\License\API\UserClient $instance) {
            unset($instance->options);
        }, $this, 'WP_Rocket\\Engine\\License\\API\\UserClient')->__invoke($this);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\License\\API\\UserClient');

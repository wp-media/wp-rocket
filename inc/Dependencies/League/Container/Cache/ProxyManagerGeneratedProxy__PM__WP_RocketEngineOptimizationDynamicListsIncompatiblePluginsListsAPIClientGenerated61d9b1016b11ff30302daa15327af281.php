...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Optimization\DynamicLists\IncompatiblePluginsLists\APIClient;

class Generated61d9b1016b11ff30302daa15327af281 extends \WP_Rocket\Engine\Optimization\DynamicLists\IncompatiblePluginsLists\APIClient implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Optimization\DynamicLists\IncompatiblePluginsLists\APIClient|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature61d9b1016b11ff30302daa15327af281 = '';

    public function get_exclusions_list($hash)
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'get_exclusions_list', array('hash' => $hash), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->get_exclusions_list($hash);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\WP_Rocket\Engine\Optimization\DynamicLists\AbstractAPIClient $instance) {
            unset($instance->response_code, $instance->error_message, $instance->response_body, $instance->options);
        }, $instance, 'WP_Rocket\\Engine\\Optimization\\DynamicLists\\AbstractAPIClient')->__invoke($instance);
    ...
    public function __construct(\WP_Rocket\Admin\Options_Data $options)
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\DynamicLists\\IncompatiblePluginsLists\\APIClient');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\WP_Rocket\Engine\Optimization\DynamicLists\AbstractAPIClient $instance) {
            unset($instance->response_code, $instance->error_message, $instance->response_body, $instance->options);
        }, $this, 'WP_Rocket\\Engine\\Optimization\\DynamicLists\\AbstractAPIClient')->__invoke($this);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\DynamicLists\\IncompatiblePluginsLists\\APIClient');

...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Support\Data;

class Generatedcbb767300cfe39c333780cbd59882ebe extends \WP_Rocket\Engine\Support\Data implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Support\Data|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signaturecbb767300cfe39c333780cbd59882ebe = '';
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\WP_Rocket\Engine\Support\Data $instance) {
            unset($instance->options, $instance->to_send);
        }, $instance, 'WP_Rocket\\Engine\\Support\\Data')->__invoke($instance);
    ...
    public function __construct(\WP_Rocket\Admin\Options_Data $options)
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Support\\Data');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\WP_Rocket\Engine\Support\Data $instance) {
            unset($instance->options, $instance->to_send);
        }, $this, 'WP_Rocket\\Engine\\Support\\Data')->__invoke($this);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Support\\Data');

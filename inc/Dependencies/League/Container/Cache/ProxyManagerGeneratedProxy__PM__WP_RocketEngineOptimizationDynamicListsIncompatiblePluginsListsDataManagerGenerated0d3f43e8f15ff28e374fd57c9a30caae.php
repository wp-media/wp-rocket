...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Optimization\DynamicLists\IncompatiblePluginsLists\DataManager;

class Generated0d3f43e8f15ff28e374fd57c9a30caae extends \WP_Rocket\Engine\Optimization\DynamicLists\IncompatiblePluginsLists\DataManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Optimization\DynamicLists\IncompatiblePluginsLists\DataManager|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature0d3f43e8f15ff28e374fd57c9a30caae = '';

    public function get_plugins_list()
    {
        $this->initializerb4055 && ($this->initializerb4055->__invoke($valueHolder5c912, $this, 'get_plugins_list', array(), $this->initializerb4055) || 1) && $this->valueHolder5c912 = $valueHolder5c912;

        return $this->valueHolder5c912->get_plugins_list();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\WP_Rocket\Engine\Optimization\DynamicLists\IncompatiblePluginsLists\DataManager $instance) {
            unset($instance->options);
        }, $instance, 'WP_Rocket\\Engine\\Optimization\\DynamicLists\\IncompatiblePluginsLists\\DataManager')->__invoke($instance);
    ...
    public function __construct(\WP_Rocket\Admin\Options_Data $options)
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\DynamicLists\\IncompatiblePluginsLists\\DataManager');
            $this->valueHolder5c912 = $reflection->newInstanceWithoutConstructor();
        unset($this->cache_duration);

        \Closure::bind(function (\WP_Rocket\Engine\Optimization\DynamicLists\IncompatiblePluginsLists\DataManager $instance) {
            unset($instance->options);
        }, $this, 'WP_Rocket\\Engine\\Optimization\\DynamicLists\\IncompatiblePluginsLists\\DataManager')->__invoke($this);
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\DynamicLists\\IncompatiblePluginsLists\\DataManager');

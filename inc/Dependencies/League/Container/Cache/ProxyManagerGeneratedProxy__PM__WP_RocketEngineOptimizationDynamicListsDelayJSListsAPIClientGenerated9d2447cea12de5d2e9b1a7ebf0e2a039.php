...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\Optimization\DynamicLists\DelayJSLists\APIClient;

class Generated9d2447cea12de5d2e9b1a7ebf0e2a039 extends \WP_Rocket\Engine\Optimization\DynamicLists\DelayJSLists\APIClient implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\Optimization\DynamicLists\DelayJSLists\APIClient|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature9d2447cea12de5d2e9b1a7ebf0e2a039 = '';
    ...
    public function __construct(\WP_Rocket\Admin\Options_Data $options)
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\DynamicLists\\DelayJSLists\\APIClient');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\Optimization\\DynamicLists\\DelayJSLists\\APIClient');

...
namespace ProxyManagerGeneratedProxy\__PM__\WP_Rocket\Engine\License\API\PricingClient;

class Generated4ad3a3afad640bdb3b4aac1cc9eb3858 extends \WP_Rocket\Engine\License\API\PricingClient implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \WP_Rocket\Engine\License\API\PricingClient|null wrapped object, if the proxy is initialized
     */
    ...
    private static $signature4ad3a3afad640bdb3b4aac1cc9eb3858 = '';
    ...
    public function __construct()
    {
        ...
        if (! $this->valueHolder5c912) {
            $reflection = $reflection ?? new \ReflectionClass('WP_Rocket\\Engine\\License\\API\\PricingClient');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('WP_Rocket\\Engine\\License\\API\\PricingClient');

...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function handleResetPage(e) {
    e.preventDefault();
    console.log($(this).parents('.wpr-speed-radar-item').data('rocketPmId'));
    $.post(ajaxurl, {
      id: id,

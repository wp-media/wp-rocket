...
((document, window) => {
  ...
  function trackRocketCDNUpsellBannerViewed(is_collapsed = false) {
    if (!isOnCDNTab()) {
      console.log('Not on CDN tab, skipping Mixpanel tracking for RocketCDN upsell banner view.');
      return;
    }

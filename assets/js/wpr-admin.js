...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function disableAddUrlElements() {
    ...
    const tooltipMessage = window.rocket_ajax_data && window.rocket_ajax_data.reach_max_url_message ? window.rocket_ajax_data.reach_max_url_message : 'Maximum number of URLs reached for your license.';
  ...
  function updateAllRetestButtons() {
    ...
    const runningRows = new Set(Array.from(document.querySelectorAll('.wpr-pma-item')).filter(row => row.querySelector('.wpr-loading-img') !== null));
...
PageManager.prototype.change = function () {
  ...
  const pagesWithoutSubmit = ['dashboard', 'addons', 'database', 'tools', 'addons', 'imagify', 'tutorials', 'plugins', 'rocket_insights'];

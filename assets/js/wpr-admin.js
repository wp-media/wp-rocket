...
(document => {
  ...
  function initCdnDriverTabs() {
    ...
    function syncSharedDriverState(activeDriver) {
      ...
      const isRocketCdnDisabled = rocketCdnStateInput ? 'paused' === rocketCdnStateInput.value : Boolean(document.querySelector('.rocketcdn .wpr-cdn-status--paused, .rocketcdn .wpr-cdn-built-in--paused, .rocketcdn .wpr-icon-orange-loader'));

  ...
  function getResults() {
    ...
    $.get(ajaxurl, {
      ...
      if (response.success && Array.isArray(response.data.results)) {
        ...
        console.log('res.data.status', response.data.global_score_data.data.status);
        console.log('globalScoreData.data.status', globalScoreData.data.status);
        console.log('res.data.num', response.data.global_score_data.data.pages_num);
        console.log('globalScoreData.data.num', globalScoreData.data.pages_num);

...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function checkInitialUrlLimit() {
    if (typeof window.rocket_ajax_data !== 'undefined' && window.rocket_ajax_data.remaining_urls !== undefined) {

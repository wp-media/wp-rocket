...
$(document).ready(function () {
  ...
  $('.wpr-radio input[type=checkbox]').on('change', function (e) {
    ...
    var excluded = ['cloudflare_auto_settings', 'cloudflare_devmode', 'analytics_enabled', 'wpr-rocketcdn-free-toggle', 'wpr-byocdn-toggle'];

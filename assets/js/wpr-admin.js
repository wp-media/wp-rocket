    ...
    window.wp.apiFetch({
      ...
      if (response.success) {
        ...
        if (response?.message && response.message.includes('Maximum number of URLs reached')) {
          ...
          const errorMsg = response?.message || localizedKey && window.rocket_ajax_data?.[localizedKey] || window.rocket_ajax_data?.rocket_insights_url_invalid || 'An error occurred. Please try again.';

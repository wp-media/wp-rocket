...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateQuotaBanner(canAddPages) {
    ...
    if (canAddPages === false) {
      ...
      // Hide quota banner and show summary info

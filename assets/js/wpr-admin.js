  ...
  function handleResetPage(e) {
    ...
    $.post(ajaxurl, {
      ...
      if (response.success) {
        ...
        // Note: We don't need to check remaining_urls here since retest doesn't add new URLs
        // The URL limit state should remain unchanged during a retest operation

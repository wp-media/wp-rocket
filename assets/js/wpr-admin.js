...
(document => {
  ...
  function initCdnDriverTabs() {
    ...
    const initialDriver = checkedToggle && 'byocdn' === checkedToggle.getAttribute('data-cdn-mode') ? 'your-own-cdn' : 'rocketcdn';

...
PageManager.prototype.change = function () {
  ...
  if (typeof rocket_ajax_data !== 'undefined' && rocket_ajax_data.show_sidebar === '1' && 'off' === localStorage.getItem('wpr-show-sidebar')) {
    localStorage.setItem('wpr-show-sidebar', 'on');
  }

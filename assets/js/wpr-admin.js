...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateRowStylingForLastItem(isExpanded = true) {
    ...
    $('.details-section-td').last().removeClass(removeState).addClass(addState);
  }

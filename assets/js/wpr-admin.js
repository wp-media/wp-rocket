...
(document => {
  ...
  function updateStatusIndicatorComponent(html) {
    ...
    const statusIndicator = Array.from(document.querySelectorAll('#wpr_cdn_status_indicator')).find(el => !el.closest('.your-own-cdn'));
    ...
    if (wasHidden) {
      ...
      const refreshed = Array.from(document.querySelectorAll('#wpr_cdn_status_indicator')).find(el => !el.closest('.your-own-cdn'));
      if (refreshed) {

...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function addCollapsedStylingToLastRow() {
   ...
   */
  function updateRowStylingForLastItem() {
    let isExpanded = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
...
class RocketMixpanel {
  ...
  _getSource() {
    let oldHash = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    if (oldHash) {
...
((document, window) => {
  ...
  function trackRocketCDNUpsellBannerViewed() {
    let is_collapsed = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    if (!isOnCDNTab()) {
      return;
    }
  ...
  function trackRocketCDNUpsellCTAClicked() {
    let iframeVisit = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

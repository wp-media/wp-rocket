	...
	public function testShouldReturnRocketCDNFieldWhenRocketCDNActive() {
		...
		$expected = [
			'cdn_cnames' => [
				...
				'helper'      => 'RocketCDN is currently active. <a href="https://b7d3i3z8.rocketcdn.me" data-beacon-article="5e4c84bd04286364bc958833" rel="noopener noreferrer" target="_blank">More Info</a>',
				'default'     => '',
	...
	public function testShouldReturnRocketCDNFieldWithCNAMEWhenRocketCDNActiveAndCNamesEmpty() {
		...
		$expected = [
			'cdn_cnames' => [
				...
				'label'       => 'CDN CNAME(s)',
				'description' => 'Specify the CNAME(s) below',
				'helper'      => 'To use RocketCDN, replace your CNAME with <code>example1.org</code>. <a href="https://b7d3i3z8.rocketcdn.me" data-beacon-article="5e4c84bd04286364bc958833" rel="noopener noreferrer" target="_blank">More Info</a>',
				'default'     => '',
				'section'     => 'cnames_section',
				'page'        => 'page_cdn',
			],

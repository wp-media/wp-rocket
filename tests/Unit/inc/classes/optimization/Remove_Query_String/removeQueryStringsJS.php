 ...
 */
class Test_removeQueryStringsJS extends FilesystemTestCase {
    private $rqs;
    ...
    public function addDefaultDataProvider() {
        return $this->getTestData( __DIR__, 'js/remove-query-strings' );
    }

    /**
     * @dataProvider addDefaultDataProvider
     */
    public function testShouldRemoveQueryStringsWhenJSURL( $original, $expected ) {
        $this->assertSame(
            $expected,
    ...
    public function addCDNDataProvider() {
        return $this->getTestData( __DIR__, 'js/remove-query-strings-cdn' );
    }

    /**
     * @dataProvider addCDNDataProvider
     */
    public function testShouldRemoveQueryStringsWhenJSURLAndCDN( $original, $expected ) {

...
/**
 * @covers \WP_Rocket\Engine\Tracking\Tracking::track_add_rocket_cdn_homepage
 * @group  Tracking
 * @group  RocketCDN
 */
class TrackAddRocketCdnHomepageTest extends TestCase {
	private $optin;
	private $mixpanel;
	private $options;
	private $user;
	...
	public function testShouldDoExpected( $config, $expected ): void {
		...
		$this->tracking->track_add_rocket_cdn_homepage( $config['source'] );
	}
}

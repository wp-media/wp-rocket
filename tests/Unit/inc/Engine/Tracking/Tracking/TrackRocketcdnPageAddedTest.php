...
/**
 * @covers \WP_Rocket\Engine\Tracking\Tracking::track_rocketcdn_page_added
 * @group  Tracking
 * @group  RocketCDN
 */
class TrackRocketcdnPageAddedTest extends TestCase {
	private $optin;
	private $mixpanel;
	private $options;
	private $tracking;
	...
	public function testShouldDoExpected( $config, $expected ): void {
		...
		$this->tracking->track_rocketcdn_page_added( $config['url'], $config['pages_count'], $config['source'] );
	}
}

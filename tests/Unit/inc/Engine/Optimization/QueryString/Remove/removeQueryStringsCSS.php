...
/**
 * @covers \WP_Rocket\Engine\Optimization\QueryString\Remove::remove_query_strings_css
 * @group  Optimize
 * @group  RemoveQueryStrings
 */
class Test_RemoveQueryStringsCSS extends TestCase {
    protected $path_to_test_data = '/inc/Engine/Optimization/QueryString/Remove/css/remove-query-strings.php';

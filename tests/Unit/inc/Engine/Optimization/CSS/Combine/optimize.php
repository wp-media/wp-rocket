<?php
namespace WP_Rocket\Tests\Unit\inc\Engine\Optimization\CSS\Combine;

use Brain\Monkey\Filters;
use Brain\Monkey\Functions;
use MatthiasMullie\Minify;
use Mockery;
use WP_Rocket\Engine\Optimization\CSS\Combine;
use WP_Rocket\Tests\Unit\inc\Engine\Optimization\TestCase;

/**
 * @covers \WP_Rocket\Engine\Optimization\CSS\Combine::optimize
 * @group Combine
 * @group CombineCSS
 */
class Test_Optimize extends TestCase {
	protected $path_to_test_data = '/inc/Engine/Optimization/CSS/Combine/combine.php';
	private $combine;
	private $minify;

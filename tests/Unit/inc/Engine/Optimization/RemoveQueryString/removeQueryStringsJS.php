...
/**
 * @covers \WP_Rocket\Engine\Optimization\RemoveQueryString::remove_query_strings_js
 * @group  Optimize
 * @group  RemoveQueryStrings
 */
class Test_RemoveQueryStringsJS extends TestCase {
    protected $path_to_test_data = '/inc/Engine/Optimization/RemoveQueryString/js/remove-query-strings.php';

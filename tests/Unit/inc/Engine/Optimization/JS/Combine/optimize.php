<?php
namespace WP_Rocket\Tests\Unit\inc\Engine\Optimization\JS\Combine;
...
use WP_Rocket\Engine\Optimization\JS\Combine;
use WP_Rocket\Tests\Unit\inc\Engine\Optimization\TestCase;

/**
 * @covers \WP_Rocket\Engine\Optimization\JS\Combine::optimize
 * @group Optimize
 * @group CombineJS
 */
class Test_Optimize extends TestCase {
	protected $path_to_test_data = '/inc/Engine/Optimization/JS/Combine/combine.php';
	private $combine;
	private $minify;

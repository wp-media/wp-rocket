<?php
namespace WP_Rocket\Tests\Unit\inc\Engine\Optimization\JS\Minify;

use Brain\Monkey\Filters;
use Brain\Monkey\Functions;
use WP_Rocket\Engine\Optimization\JS\Minify;
use WP_Rocket\Tests\Unit\inc\Engine\Optimization\TestCase;

/**
 * @covers \WP_Rocket\Engine\Optimization\JS\Minify::optimize
 * @group Optimize
 * @group MinifyJS
 */
class Test_Optimize extends TestCase {
	protected $path_to_test_data = '/inc/Engine/Optimization/JS/Minify/optimize.php';
	protected $minify;

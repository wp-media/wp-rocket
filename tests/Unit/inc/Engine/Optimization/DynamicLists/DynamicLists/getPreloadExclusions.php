...
/**
 * Test class covering \WP_Rocket\Engine\Optimization\DynamicLists::get_preload_exclusions
 *
 * @group  DynamicLists
 */
class Test_GetPreloadExclusions extends TestCase {
	/**
	...
	public function testShouldReturnExpected( $list, $expected ) {
		...
		$this->assertSame(
			$expected,
			$dynamic_lists->get_preload_exclusions()
		);
	}
}

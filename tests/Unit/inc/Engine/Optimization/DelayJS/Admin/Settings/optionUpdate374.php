...
/**
 * @covers \WP_Rocket\Engine\Optimization\DelayJS\Admin\Settings::option_update_3_7_4
 *
 * @group  DelayJS
 */
class Test_OptionUpdate374 extends TestCase {
	/**
	...
	public function testShouldDoExpected( $config, $expected ) {
		...
		$settings->option_update_3_7_4( $config['old_version'] );
	}
}

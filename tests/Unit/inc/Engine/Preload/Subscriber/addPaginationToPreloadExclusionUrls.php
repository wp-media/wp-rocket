...
class Test_AddPaginationToPreloadExclusionUrls extends TestCase {
	...
	public function testShouldDoAsExpected($config, $expected) {
		$this->assertSame($expected, $this->subscriber->add_pagination_to_preload_exclusion_urls($config));
	}
}

...
/**
 * Test class covering \WP_Rocket\Engine\Admin\PerformanceMonitoring\Context\PerformanceMonitoringContext::should_hide_rocket_insights
 *
...
class ShouldHideRocketInsights extends TestCase {
	...
	public function testShouldReturnExpected( $is_reseller, $is_live_site, $expected ) {
		...
		$this->assertEquals(
			$expected,
			$this->context->should_hide_rocket_insights()
		);
	}
}
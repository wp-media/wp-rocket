...
class TestAddSidebarData extends TestCase {
	...
	/**
	 * Tests that add_sidebar_data merges show_sidebar into the input array.
	 *
	 ...
	 */
	public function testShouldMergeShowSidebarIntoData( $sidebar_value, $input_data, $expected ): void {
		$this->page

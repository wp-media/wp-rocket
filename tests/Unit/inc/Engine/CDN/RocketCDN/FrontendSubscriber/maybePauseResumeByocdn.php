...
/**
 * @covers \WP_Rocket\Engine\CDN\RocketCDN\FrontendSubscriber::maybe_pause_resume_byocdn
 * @group  CDN
 * @group  RocketCDN
 */
class Test_MaybePauseResumeByocdn extends TestCase {
	...
	public function testShouldReturnExpectedValue( array $config, $expected ) {
		...
		$this->assertSame( $expected, $this->subscriber->maybe_pause_resume_byocdn( $config['value'] ) );
	}
}

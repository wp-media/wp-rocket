...
/**
 * Class TaskScheduler_CronSchedule_Test
 * @todo
 * @group schedules
 */
class TaskScheduler_CronSchedule_Test extends TaskScheduler_UnitTestCase {
	public function test_creation() {
		$time = new DateTime('tomorrow');
		$cron = CronExpression::factory('@daily');
		$schedule = new TaskScheduler_CronSchedule($time, $cron);

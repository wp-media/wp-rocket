...
return [
    ...
    'shouldDisplayNoticeWhenASTablesAreMissing' => [
        ...
        'expected' => [
            'status'  => 'error',
            'message' => 'WP Rocket: We detected missing database table related to Action Scheduler. Please visit the following URL to recreate it, as it is needed for WP Rocket to work correctly.',

...
return [
	'testDefaultSiteURL' => [
		...
		'expected' => file_get_contents( WP_ROCKET_TESTS_FIXTURES_DIR . '/inc/Engine/CDN/Subscriber/HTML/siteURL/rewrite.html' ),
	],
	'testSiteURLWithPath' => [
		...
		'expected' => file_get_contents( WP_ROCKET_TESTS_FIXTURES_DIR . '/inc/Engine/CDN/Subscriber/HTML/siteURLWithPath/rewrite.html' ),
	],
];

...
return [
	...
	<img class="size-full wp-image-905 alignright" title="Image Alignment 300x200" alt="Image Alignment 300x200" src="http://cdn.example.org/wp-content/uploads/2013/03/image-alignment-300x200.jpg" width="300" height="200" />
	...
	<img src="http://cdn.example.org/wp-content/rocket-test-data/images/test3.gif" loading="lazy" srcset="http://cdn.example.org/wp-content/rocket-test-data/images/test1.jpeg, https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlriCLaxuV9pFTwhP2tpXTbdT5v5-uhwes6A&usqp=CAU" sizes="(max-width: 767px) 37vw, (max-width: 991px) 34vw, 37vw" alt="Absolute&rel-scrset-images">',
	'test_data' => [

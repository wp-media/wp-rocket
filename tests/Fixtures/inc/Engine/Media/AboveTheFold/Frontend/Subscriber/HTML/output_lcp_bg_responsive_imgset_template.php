...
<head>
	<?php wp_head() ?>
	<title>lcp_bg_responsive_template</title><link rel="preload" rocket-preload as="image" imagesrcset="http://example.org/wp-content/rocket-test-data/images/lcp/testavif.avif 1dppx,http://example.org/wp-content/rocket-test-data/images/lcp/testwebp.webp 2dppx" fetchpriority="high">
	<style>

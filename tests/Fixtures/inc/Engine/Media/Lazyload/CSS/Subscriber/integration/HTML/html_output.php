  ...
  background-image:url('https://wprocketest.test/wp-content/uploads/2015/05/132204857.jpg');
	...
	<noscript>
		<style id="wpr-lazyload-bg-nostyle">
			:root{--wpr-bg-hash: url('/test.png');}:root{--wpr-bg-hash: url('https://upload.wikimedia.org/wikipedia/commons/1/11/Test-Logo.svg');}:root{--wpr-bg-hash: url('https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/images/paper.jpeg');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/paper.jpeg');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/paper.jpeg');}:root{--wpr-bg-hash: url('/test_excluded.png');}:root{--wpr-bg-hash: url('https://upload.wikimedia.org/wikipedia/commons/1/11/Test-Logo.svg');}:root{--wpr-bg-hash: url('https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/styles/./wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url('https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/images/papertest.jpeg');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/testnotExist.png');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/butterfly.avif');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/file_example_TIFF_1MB.tiff');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/paper.jpeg');}:root{--wpr-bg-hash: url('https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/paper.jpeg');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/paper.jpeg');}</style>
	</noscript>

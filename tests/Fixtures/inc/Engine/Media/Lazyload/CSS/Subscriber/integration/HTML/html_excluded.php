...
<head>
	...
	<noscript>
		<style id="wpr-lazyload-bg-nostyle">
			:root{--wpr-bg-hash: url("https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/images/paper.jpeg");}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url("/wp-content/rocket-test-data/images/paper.jpeg");}:root{--wpr-bg-hash: url(/wp-content/rocket-test-data/images/paper.jpeg);}:root{--wpr-bg-hash: url('https://upload.wikimedia.org/wikipedia/commons/1/11/Test-Logo.svg');}:root{--wpr-bg-hash: url( "/wp-content/rocket-test-data/images/paper.jpeg" );}:root{--wpr-bg-hash: url('/test.png');}:root{--wpr-bg-hash: url('https://upload.wikimedia.org/wikipedia/commons/1/11/Test-Logo.svg');}:root{--wpr-bg-hash: url("/wp-content/rocket-test-data/images/paper.jpeg");}:root{--wpr-bg-hash: url('https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url( "/wp-content/rocket-test-data/images/paper.jpeg" );}:root{--wpr-bg-hash: url("/wp-content/rocket-test-data/images/paper.jpeg");}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/testnotExist.png');}:root{--wpr-bg-hash: url(/wp-content/rocket-test-data/images/butterfly.avif);}:root{--wpr-bg-hash: url(/wp-content/rocket-test-data/images/file_example_TIFF_1MB.tiff);}</style>
	</noscript>
	<script type="application/javascript">
		const rocket_pairs = [{"selector":".external-css-background-image","style":":root{--wpr-bg-hash: url(\"https:\/\/new.rocketlabsqa.ovh\/wp-content\/rocket-test-data\/images\/paper.jpeg\");}"},{"selector":".external-css-background-images","style":":root{--wpr-bg-hash: url('\/wp-content\/rocket-test-data\/images\/test.png');}"},{"selector":".external-css-background-images","style":":root{--wpr-bg-hash: url(\"\/wp-content\/rocket-test-data\/images\/paper.jpeg\");}"},{"selector":".external-css-background-image-gradient","style":":root{--wpr-bg-hash: url(\/wp-content\/rocket-test-data\/images\/paper.jpeg);}"},{"selector":".external-css-background-image-gradient","style":":root{--wpr-bg-hash: url('https:\/\/upload.wikimedia.org\/wikipedia\/commons\/1\/11\/Test-Logo.svg');}"},{"selector":".external-css-background-images","style":":root{--wpr-bg-hash: url( \"\/wp-content\/rocket-test-data\/images\/paper.jpeg\" );}"},{"selector":".external-css-background","style":":root{--wpr-bg-hash: url('\/test.png');}"},{"selector":".external-css-backgroundsvg","style":":root{--wpr-bg-hash: url('https:\/\/upload.wikimedia.org\/wikipedia\/commons\/1\/11\/Test-Logo.svg');}"},{"selector":".internal-css-background-image","style":":root{--wpr-bg-hash: url(\"\/wp-content\/rocket-test-data\/images\/paper.jpeg\");}"},{"selector":".internal-css-background-images","style":":root{--wpr-bg-hash: url('https:\/\/new.rocketlabsqa.ovh\/wp-content\/rocket-test-data\/images\/test.png');}"},{"selector":".internal-css-background-images","style":":root{--wpr-bg-hash: url( \"\/wp-content\/rocket-test-data\/images\/paper.jpeg\" );}"},{"selector":".internal-css-background-image-gradient","style":":root{--wpr-bg-hash: url(\"\/wp-content\/rocket-test-data\/images\/paper.jpeg\");}"},{"selector":".internal-css-background","style":":root{--wpr-bg-hash: url('\/wp-content\/rocket-test-data\/images\/test.png');}"},{"selector":".internal-css-background404","style":":root{--wpr-bg-hash: url('\/wp-content\/rocket-test-data\/images\/testnotExist.png');}"},{"selector":"#internal-BG-images","style":":root{--wpr-bg-hash: url(\/wp-content\/rocket-test-data\/images\/butterfly.avif);}"},{"selector":"#internal-BG-images","style":":root{--wpr-bg-hash: url(\/wp-content\/rocket-test-data\/images\/file_example_TIFF_1MB.tiff);}"}];</script>
</head>
<body>
<div>
	<h2>

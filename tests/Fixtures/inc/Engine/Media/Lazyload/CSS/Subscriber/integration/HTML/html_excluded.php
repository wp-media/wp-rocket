...
.my-style-rocks{
  background-image:url('https://wprocketest.test/wp-content/uploads/2015/05/132204857.jpg');
	...
	<style id="wpr-lazyload-bg-exclusion">
		:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url( "/wp-content/rocket-test-data/images/paper.jpeg" );}:root{--wpr-bg-hash: url(https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/styles/./wp-content/rocket-test-data/images/test.png);}:root{--wpr-bg-hash: url(/wp-content/rocket-test-data/images/paper.jpeg);}</style>
	<noscript>
		<style id="wpr-lazyload-bg-nostyle">
			:root{--wpr-bg-hash: url('/test.png');}:root{--wpr-bg-hash: url('https://upload.wikimedia.org/wikipedia/commons/1/11/Test-Logo.svg');}:root{--wpr-bg-hash: url("https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/images/paper.jpeg");}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url( "/wp-content/rocket-test-data/images/paper.jpeg" );}:root{--wpr-bg-hash: url(/wp-content/rocket-test-data/images/paper.jpeg);}:root{--wpr-bg-hash: url(https://upload.wikimedia.org/wikipedia/commons/1/11/Test-Logo.svg);}:root{--wpr-bg-hash: url(https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/images/paper.jpeg);}:root{--wpr-bg-hash: url(https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/styles/./wp-content/rocket-test-data/images/test.png);}:root{--wpr-bg-hash: url(/wp-content/rocket-test-data/images/paper.jpeg);}:root{--wpr-bg-hash: url(https://upload.wikimedia.org/wikipedia/commons/1/11/Test-Logo.svg);}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url('/wp-content/rocket-test-data/images/testnotExist.png');}:root{--wpr-bg-hash: url(/wp-content/rocket-test-data/images/butterfly.avif);}:root{--wpr-bg-hash: url(/wp-content/rocket-test-data/images/file_example_TIFF_1MB.tiff);}:root{--wpr-bg-hash: url("/wp-content/rocket-test-data/images/paper.jpeg");}:root{--wpr-bg-hash: url('https://new.rocketlabsqa.ovh/wp-content/rocket-test-data/images/test.png');}:root{--wpr-bg-hash: url( "/wp-content/rocket-test-data/images/paper.jpeg" );}:root{--wpr-bg-hash: url("/wp-content/rocket-test-data/images/paper.jpeg");}</style>
	</noscript>
	<script type="application/javascript">
		const rocket_pairs = [{"selector":".external-css-background","style":":root{--wpr-bg-hash: url('\/test.png');}"},{"selector":".external-css-backgroundsvg","style":":root{--wpr-bg-hash: url('https:\/\/upload.wikimedia.org\/wikipedia\/commons\/1\/11\/Test-Logo.svg');}"},{"selector":".external-css-background-image","style":":root{--wpr-bg-hash: url(\"https:\/\/new.rocketlabsqa.ovh\/wp-content\/rocket-test-data\/images\/paper.jpeg\");}"},{"selector":".external-css-background-images","style":":root{--wpr-bg-hash: url('\/wp-content\/rocket-test-data\/images\/test.png');}"},{"selector":".external-css-background-images","style":":root{--wpr-bg-hash: url( \"\/wp-content\/rocket-test-data\/images\/paper.jpeg\" );}"},{"selector":".external-css-background-image-gradient","style":":root{--wpr-bg-hash: url(\/wp-content\/rocket-test-data\/images\/paper.jpeg);}"},{"selector":".external-css-background","style":":root{--wpr-bg-hash: url(https:\/\/upload.wikimedia.org\/wikipedia\/commons\/1\/11\/Test-Logo.svg);}"},{"selector":".external-css-background-image","style":":root{--wpr-bg-hash: url(https:\/\/new.rocketlabsqa.ovh\/wp-content\/rocket-test-data\/images\/paper.jpeg);}"},{"selector":".external-css-background-images","style":":root{--wpr-bg-hash: url(https:\/\/new.rocketlabsqa.ovh\/wp-content\/rocket-test-data\/styles\/.\/wp-content\/rocket-test-data\/images\/test.png);}"},{"selector":".external-css-background-images","style":":root{--wpr-bg-hash: url(\/wp-content\/rocket-test-data\/images\/paper.jpeg);}"},{"selector":".external-css-background-image-gradient","style":":root{--wpr-bg-hash: url(https:\/\/upload.wikimedia.org\/wikipedia\/commons\/1\/11\/Test-Logo.svg);}"},{"selector":".internal-css-background","style":":root{--wpr-bg-hash: url('\/wp-content\/rocket-test-data\/images\/test.png');}"},{"selector":".internal-css-background404","style":":root{--wpr-bg-hash: url('\/wp-content\/rocket-test-data\/images\/testnotExist.png');}"},{"selector":"#internal-BG-images","style":":root{--wpr-bg-hash: url(\/wp-content\/rocket-test-data\/images\/butterfly.avif);}"},{"selector":"#internal-BG-images","style":":root{--wpr-bg-hash: url(\/wp-content\/rocket-test-data\/images\/file_example_TIFF_1MB.tiff);}"},{"selector":".internal-css-background-image","style":":root{--wpr-bg-hash: url(\"\/wp-content\/rocket-test-data\/images\/paper.jpeg\");}"},{"selector":".internal-css-background-images","style":":root{--wpr-bg-hash: url('https:\/\/new.rocketlabsqa.ovh\/wp-content\/rocket-test-data\/images\/test.png');}"},{"selector":".internal-css-background-images","style":":root{--wpr-bg-hash: url( \"\/wp-content\/rocket-test-data\/images\/paper.jpeg\" );}"},{"selector":".internal-css-background-image-gradient","style":":root{--wpr-bg-hash: url(\"\/wp-content\/rocket-test-data\/images\/paper.jpeg\");}"}];</script>
</head>
<body>
<div>
	<h2>
		Background images from internal CSS</h2>
</div>
...
<div>
	<p  class='internal-css-background-image-gradient'>
		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi gravida diam in tristique feugiat. In in metus faucibus, condimentum turpis ac, congue mauris. Integer ac varius erat, nec imperdiet odio. Maecenas sit amet dapibus risus. Pellentesque scelerisque cursus lacus a tristique. Maecenas bibendum, erat vitae interdum hendrerit, nibh diam convallis risus, nec sollicitudin est neque eu nunc. Aenean condimentum viverra est a congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec viverra erat mauris, scelerisque interdum nisl hendrerit eu.</p>
</div>
<div>
...
<div>
	<p  class='internal-css-background404'>
		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi gravida diam in tristique feugiat. In in metus faucibus, condimentum turpis ac, congue mauris. Integer ac varius erat, nec imperdiet odio. Maecenas sit amet dapibus risus. Pellentesque scelerisque cursus lacus a tristique. Maecenas bibendum, erat vitae interdum hendrerit, nibh diam convallis risus, nec sollicitudin est neque eu nunc. Aenean condimentum viverra est a congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec viverra erat mauris, scelerisque interdum nisl hendrerit eu.</p>
</div>
<div>
	<p  class='internal-css-backgroundsvg'>
		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi gravida diam in tristique feugiat. In in metus faucibus, condimentum turpis ac, congue mauris. Integer ac varius erat, nec imperdiet odio. Maecenas sit amet dapibus risus. Pellentesque scelerisque cursus lacus a tristique. Maecenas bibendum, erat vitae interdum hendrerit, nibh diam convallis risus, nec sollicitudin est neque eu nunc. Aenean condimentum viverra est a congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec viverra erat mauris, scelerisque interdum nisl hendrerit eu.</p>
</div>
...
<div>
	<h2>
		Background images from external CSS</h2>
</div>
...
<div>
	<p  class='external-css-background-images background-no-repeat'>
		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi gravida diam in tristique feugiat. In in metus faucibus, condimentum turpis ac, congue mauris. Integer ac varius erat, nec imperdiet odio. Maecenas sit amet dapibus risus. Pellentesque scelerisque cursus lacus a tristique. Maecenas bibendum, erat vitae interdum hendrerit, nibh diam convallis risus, nec sollicitudin est neque eu nunc. Aenean condimentum viverra est a congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec viverra erat mauris, scelerisque interdum nisl hendrerit eu.</p>
</div>
<div>
	<p  class='external-css-background-image_gradient'>
		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi gravida diam in tristique feugiat. In in metus faucibus, condimentum turpis ac, congue mauris. Integer ac varius erat, nec imperdiet odio. Maecenas sit amet dapibus risus. Pellentesque scelerisque cursus lacus a tristique. Maecenas bibendum, erat vitae interdum hendrerit, nibh diam convallis risus, nec sollicitudin est neque eu nunc. Aenean condimentum viverra est a congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec viverra erat mauris, scelerisque interdum nisl hendrerit eu.</p>
</div>
...
<div>
	<p  class='external-css-background-image-gradient'>
		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi gravida diam in tristique feugiat. In in metus faucibus, condimentum turpis ac, congue mauris. Integer ac varius erat, nec imperdiet odio. Maecenas sit amet dapibus risus. Pellentesque scelerisque cursus lacus a tristique. Maecenas bibendum, erat vitae interdum hendrerit, nibh diam convallis risus, nec sollicitudin est neque eu nunc. Aenean condimentum viverra est a congue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec viverra erat mauris, scelerisque interdum nisl hendrerit eu.</p>
</div>
<div>
...
<div class="javascript-background-image">
	<h2>
		JavaScript added background image</h2>
</div>
<!-- internal CSS -->
<style>
	body{

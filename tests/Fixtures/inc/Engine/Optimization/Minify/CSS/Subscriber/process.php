		...
		'minifyCssFiles' => [
			...
			'expected' => [
				'html'  => '<html>
					...
					<body>
					<script>var rocket_lcp_data = {"ajax_url":"http:\/\/example.org\/wp-admin\/admin-ajax.php","nonce":"'.wp_create_nonce( 'rocket_lcp' ).'","url":"http:\/\/example.org","is_mobile":false,"width_threshold":1920,"height_threshold":1080}</script>

...
<html>
	<head>
		<title>Sample Page</title><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Crimson+Pro:wght@450&family=Comfortaa&text=Hello&display=swap" />
	</head>
	<body>
	</body>
</html>
...
<html>
	<head>
		<title>Sample Page</title><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Goldman:wght@700&family=Roboto:ital,wght@0,100;0,400;0,500;1,500;1,900&family=Comfortaa&text=Hello&display=swap" />
		<link rel="preconnect" href="https://fonts.gstatic.com">
	</head>
	<body>
	</body>

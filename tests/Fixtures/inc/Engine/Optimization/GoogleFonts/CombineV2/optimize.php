...
return [
	...
	'shouldReturnTagWithFontDisplayWhenSingleTagGiven' => [
		...
		'expected' => [
			...
			<html>
				<head>
					<title>Sample Page</title>
					<link as="style" href="https://fonts.googleapis.com/css2?family=Crimson+Pro:wght@450&#038;display=swap" rel="preload" data-rocket-preload>
	...
	'shouldCombineMultipleTags' => [
		...
		'expected' => [
			...
			<html>
				<head>
					<title>Sample Page</title>
					<link as="style" href="https://fonts.googleapis.com/css2?family=Crimson+Pro:wght@450&#038;family=Comfortaa&#038;display=swap" rel="preload" data-rocket-preload>
	...
	'shouldCombineMultipleTagsWithMultipleFamiliesInTag' => [
		...
		'expected' => [
			...
			<html>
				<head>
					<title>Sample Page</title>
					<link as="style" href="https://fonts.googleapis.com/css2?family=Goldman:wght@700&#038;family=Roboto:ital,wght@0,100;0,400;0,500;1,500;1,900&#038;family=Comfortaa&#038;display=swap" rel="preload" data-rocket-preload>
	...
	'shouldReplaceDisplayValueWithFilteredValue' => [
		...
		'expected' => [
			...
			<head>
			<title>Sample Page</title>
			<link as="style" href="https://fonts.googleapis.com/css2?family=Goldman:wght@700&#038;family=Roboto:ital,wght@0,100;0,400;0,500;1,500;1,900&#038;family=Comfortaa&#038;display=optional" rel="preload" data-rocket-preload>
	...
	'shouldExcludeFontFromCombine' => [
		...
		'expected' => [
			...
			<title>
			Sample Page</title>
			<link as="style" href="https://fonts.googleapis.com/css2?family=Goldman:wght@700&#038;family=Roboto:ital,wght@0,100;0,400;0,500;1,500;1,900&#038;family=MontSerra:ital,wght@0,100;0,400;0,500;1,500;1,900&#038;family=Comfortaa&#038;display=optional" rel="preload" data-rocket-preload>

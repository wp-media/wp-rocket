...
$html = <<<HTML
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7nuSIID7tWZdjT6cI5ZTKGbjFPBOGNM0&#038;language=en&#038;ver=1"></script>
...
$expected = <<<HTML
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7nuSIID7tWZdjT6cI5ZTKGbjFPBOGNM0&#038;language=en&#038;ver=1" defer></script>
	<script integrity="sha512-VtmdOFNyOniRUIHzkfL4GAe+yuAhoWzJIWYW/9elcd+7zNu12OKscWFIe9PRQ6VBy4djrwGVzK6MLD3oTpLpRQ==" crossorigin="anonymous" src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.5.0/js/bootstrap.js" defer></script>
...
return [
	...
	'testShouldReturnUpdatedHTMLWhenSafeModeEnabled' => [
		'config' => [
			'donotrocketoptimize' => false,
			'post_meta'           => false,
			'options'             => [

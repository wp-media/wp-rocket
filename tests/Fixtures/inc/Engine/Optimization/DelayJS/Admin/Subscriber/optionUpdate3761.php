...
return [
	...
	'ShouldResetDefaultListWhenSettingIsCorrupt' => [
		'config'        => [
			'old_version'   => '3.7.6',
			'valid_version' => true,
			'initial_list'  => 'This is a bogus string where the settings array should be.',
		],
		'expected_list' => [
			'getbutton.io',
			'//a.omappapi.com/app/js/api.min.js',
	...
	'ShouldResetDefaultListWhenSettingIsMissing' => [
		'config'        => [
			'old_version'   => '3.7.6',
			'valid_version' => true,
			'initial_list'  => null,

...
return [
	...
	'test_data' => [
		...
		// CDN URL, JS files are cached busted. Files with the WordPress version in the query get the ?ver= removed.
		[
			'<html>
				<head>
					<title>Page title</title>
		...
		// CDN URL with subdirectory, JS files are cached busted. Files with the WordPress version in the query get the ?ver= removed.
		[
			'<html>
				<head>
					<title>Page title</title>

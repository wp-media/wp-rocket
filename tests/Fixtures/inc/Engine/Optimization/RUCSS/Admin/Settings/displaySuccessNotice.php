...
return [
	...
	'shouldHideNoticeWhenTransient' => [
		...
		'expected' => [
			'message'     => '<strong>WP Rocket</strong>: Your homepage has been processed. WP Rocket will continue to generate Used CSS for up to 100 URLs per 60 second(s). We suggest enabling <a href="#preload">Preload</a> for the fastest results.<br>To learn more about the process check our <a href="http://example.org" data-beacon-article="123" rel="noopener noreferrer" target="_blank">documentation</a>.',
			'dismissible' => 'hidden',

	...
	[
		...
		'<html>' .
			'<head>' .
				...
				'<script data-minify="1" type="text/javascript" src="http://example.org/wp-content/cache/min/1/wp-includes/js/jquery/jquery-c9eeccad7a0ad8b9ca4b57d493258a2d.js"></script>' .
			'</head>' .
			'<body>' .
			'</body>' .
		'</html>',

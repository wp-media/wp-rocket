...
namespace WP_Rocket\Tests\Integration\inc\classes\subscriber\Optimization\Minify_JS_Subscriber;

use Brain\Monkey\Functions;
use WP_Rocket\Tests\Integration\FilesystemTestCase;

/**
 * @covers \WP_Rocket\Subscriber\Optimization\Minify_JS_Subscriber::process
 * @group  MinifyJS
 */
class Test_Process extends FilesystemTestCase {
    protected $path_to_test_data = '/inc/classes/subscriber/Optimization/Minify_JS_Subscriber/process.php';
    protected $cnames;
    protected $zones;

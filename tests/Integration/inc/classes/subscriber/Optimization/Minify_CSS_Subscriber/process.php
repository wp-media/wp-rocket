...
namespace WP_Rocket\Tests\Integration\inc\classes\subscriber\Optimization\Minify_CSS_Subscriber;
...
class Test_Process extends FilesystemTestCase {
    protected $path_to_test_data = '/inc/classes/subscriber/Optimization/Minify_CSS_Subscriber/process.php';
    protected $cnames;
    protected $zones;

...
class Test_IsSpeedTool extends TestCase
{
    public function testShouldReturnTrueWhenLighthouse()
    {
        ...
        $config = new Config(['config_dir_path' => 'wp-content/wp-rocket/config', 'server' => ['HTTP_USER_AGENT' => 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36(KHTML, like Gecko) Chrome/61.0.3116.0 Safari/537.36 Chrome-Lighthouse']]);

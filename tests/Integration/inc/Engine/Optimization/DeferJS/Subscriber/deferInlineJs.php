...
class Test_DeferInlineJs extends TestCase
{
    ...
    public function testShouldReturnExpected($config, $html, $expected)
    {
        ...
        $this->goToContentType(['type' => 'is_post', 'post_data' => ['import_id' => 100]]);
        ...
        $this->assertSame($this->format_the_html($expected), $this->format_the_html(apply_filters('rocket_buffer', $html)));
    }

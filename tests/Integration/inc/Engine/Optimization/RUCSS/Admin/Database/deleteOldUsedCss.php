...
class Test_DeleteOldUsedCss extends TestCase
{
    ...
    public function testShouldTruncateTableWhenOptionIsEnabled()
    {
        ...
        $rucss_usedcss_query->add_item(['url' => 'http://example.org/home', 'css' => 'h1{color:red;}', 'retries' => 3, 'is_mobile' => false, 'last_accessed' => $current_date]);
        $rucss_usedcss_query->add_item(['url' => 'http://example.org/home', 'css' => 'h1{color:red;}', 'retries' => 3, 'is_mobile' => true, 'last_accessed' => $old_date]);

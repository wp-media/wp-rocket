...
class Test_DisplayNoTableNotice extends AdminTestCase
{
    ...
    public function testShouldDoAsExpected($config, $expected)
    {
        ...
        if ($expected['contains']) {
            $this->assertStringContainsString($this->format_the_html($content), $this->format_the_html($result));
        } else {
            $this->assertStringNotContainsString($this->format_the_html($content), $this->format_the_html($result));
        }
    }

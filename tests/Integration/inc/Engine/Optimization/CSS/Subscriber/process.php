...
namespace WP_Rocket\Tests\Integration\inc\Engine\Optimization\Subscriber;

use Brain\Monkey\Functions;
use WP_Rocket\Tests\Integration\FilesystemTestCase;

/**
 * @covers \WP_Rocket\Engine\Optimization\Subscriber::process
 * @group  MinifyCSS
 */
class Test_Process extends FilesystemTestCase {
    protected $path_to_test_data = '/inc/Engine/Optimization/CSS/Subscriber/process.php';
    protected $cnames;
    protected $zones;

 ...
 * @group AdminOnly
 */
class Test_IsCancelledOutsideGracePeriod extends AbstractSubscriptionControllerTestCase {
	...
	public function testShouldDoAsExpected( array $config, bool $expected ): void {
		...
		$this->assertSame( $expected, $this->subscription_controller->is_cancelled_outside_grace_period() );
	}
}

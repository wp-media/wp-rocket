...
class Test_Enable extends ApiTestCase
{
    ...
    {
        $body_params = ['email' => self::getApiCredential('ROCKET_EMAIL'), 'key' => self::getApiCredential('ROCKET_KEY'), 'url' => 'https://rocketcdn.me'];
        $this->requestEnableEndpoint($body_params);
        $expected_subset = ['cdn' => 1, 'cdn_cnames' => ['https://rocketcdn.me'], 'cdn_zone' => ['all']];

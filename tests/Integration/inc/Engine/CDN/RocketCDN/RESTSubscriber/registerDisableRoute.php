...
class Test_RegisterDisableRoute extends ApiTestCase
{
    ...
    {
        $actual = $this->requestDisableEndpoint(['email' => 'nulled@wp-rocket.me', 'key' => self::getApiCredential('ROCKET_KEY')]);
    ...
    {
        $actual = $this->requestDisableEndpoint(['email' => self::getApiCredential('ROCKET_EMAIL'), 'key' => '0123456']);
    ...
    {
        $actual = $this->requestDisableEndpoint(['email' => 'nulled@wp-rocket.me', 'key' => '0123456']);
    ...
    {
        $actual = $this->requestDisableEndpoint(['email' => self::getApiCredential('ROCKET_EMAIL'), 'key' => self::getApiCredential('ROCKET_KEY')]);
        $expected = ['code' => 'success', 'message' => __('RocketCDN disabled', 'rocket'), 'data' => ['status' => 200]];

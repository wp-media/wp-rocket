...
/**
 * Test class covering WP_Rocket\Engine\Admin\PerformanceMonitoring\Subscriber::reset_global_score
 *
...
class ResetGlobalScoreTest extends TestCase {
	...
	public function set_up() {
		...
		add_filter( 'rocket_pm_global_score_reset_test', [ $this, 'capture_reset_called' ] );
	...
	public function tear_down() {
		...
		// Remove test filter
		remove_filter( 'rocket_pm_global_score_reset_test', [ $this, 'capture_reset_called' ] );

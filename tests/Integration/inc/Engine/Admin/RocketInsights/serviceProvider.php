...
use WP_Rocket\Engine\Admin\RocketInsights\Database\Queries\RocketInsights as PMQuery;
use WP_Rocket\Engine\Admin\RocketInsights\Database\Tables\RocketInsights as PMTable;
use WP_Rocket\Engine\Admin\RocketInsights\APIHandler\APIClient as PMAPIClient;
use WP_Rocket\Engine\Admin\RocketInsights\Context\RocketInsightsContext;
use WP_Rocket\Engine\Admin\RocketInsights\Jobs\Factory as PMFactory;
use WP_Rocket\Engine\Admin\RocketInsights\Jobs\Manager as PMManager;
use WP_Rocket\Engine\Admin\RocketInsights\Queue\Queue as PMQueue;
...
class Test_ServiceProvider extends TestCase {
	...
	public function testShouldRegisterServicesInContainer() {
		...
		$this->assertInstanceOf( RocketInsightsContext::class, $pm_context );
	...
	public function testShouldHaveNewInstancesForNonSharedServices() {
		...
		$this->assertInstanceOf( RocketInsightsContext::class, $pm_context_1 );

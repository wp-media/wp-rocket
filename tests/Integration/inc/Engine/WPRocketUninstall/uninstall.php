...
class Test_Uninstall extends FilesystemTestCase
{
    ...
    private static $options = ['wp_rocket_settings' => null, 'rocket_analytics_notice_displayed' => null, 'rocketcdn_user_token' => null, 'rocketcdn_process' => null];
    protected static $transients = ['wp_rocket_customer_data' => null, 'rocket_notice_missing_tags' => null, 'rocket_clear_cache' => null, 'rocket_check_key_errors' => null, 'rocket_send_analytics_data' => null, 'rocket_critical_css_generation_process_running' => null, 'rocket_critical_css_generation_process_complete' => null, 'rocket_critical_css_generation_triggered' => null, 'rocketcdn_status' => null, 'rocketcdn_pricing' => null, 'rocketcdn_purge_cache_response' => null, 'rocket_cloudflare_ips' => null, 'rocket_cloudflare_is_api_keys_valid' => null, 'rocket_preload_triggered' => null, 'rocket_preload_complete' => null, 'rocket_preload_complete_time' => null, 'rocket_preload_errors' => null, 'rocket_database_optimization_process' => null, 'rocket_database_optimization_process_complete' => null];
    private $events = ['rocket_purge_time_event', 'rocket_database_optimization_time_event', 'rocket_cache_dir_size_check', 'rocketcdn_check_subscription_status_event', 'rocket_cron_deactivate_cloudflare_devmode'];

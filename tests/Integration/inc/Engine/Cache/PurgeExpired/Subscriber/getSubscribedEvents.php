...
class TestGetSubscribedEvents extends TestCase
{
    ...
    {
        $events = ['init' => 'schedule_event', 'rocket_deactivation' => 'unschedule_event', 'rocket_purge_time_event' => 'purge_expired_files', 'cron_schedules' => 'custom_cron_schedule', 'wp_rocket_upgrade' => ['update_lifespan_option_on_update', 13, 2]];

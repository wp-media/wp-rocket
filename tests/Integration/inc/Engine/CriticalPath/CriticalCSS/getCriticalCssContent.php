...
class Test_GetCriticalCssContent extends FilesystemTestCase
{
    ...
    public static function set_up_before_class()
    {
        ...
        self::$user_id = static::factory()->user->create(['role' => 'adminstrator', 'user_nicename' => 'rocket_tester']);
    }
    ...
    public function testShouldDoExpected($config, $expected)
    {
        ...
        $this->assertSame($expected, self::$critical_css->get_critical_css_content());
    }

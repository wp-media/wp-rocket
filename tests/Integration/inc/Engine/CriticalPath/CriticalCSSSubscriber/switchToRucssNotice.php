...
class Test_switchToRucssNotice extends TestCase
{
    ...
    public function testShouldDoAsExpected($config, $expected)
    {
        ...
        if ($expected['contains']) {
            $this->assertStringContainsString($this->format_the_html($expected['content']), $this->format_the_html($result));
        } else {
            $this->assertStringNotContainsString($this->format_the_html($expected['content']), $this->format_the_html($result));
        }
    }
    ...
    {
        return ['disable' => $this->config['rucss_status']];
    }
}

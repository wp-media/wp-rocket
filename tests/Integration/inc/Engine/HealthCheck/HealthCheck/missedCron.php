...
class Test_MissedCron extends TestCase
{
    ...
    public function set_up()
    {
        ...
        Functions\expect('wp_create_nonce')->with('rocket_ignore_rocket_warning_cron')->andReturn('123456');
    }
    ...
    public function testShouldReturnNullWhenNothingToDisplay(array $config, $expected)
    {
        ...
        $expected = empty($expected) ? $expected : $this->format_the_html($expected);
    ...
    private function getActualHtml()
    {
        ...
        $actual = ob_get_clean();
        return empty($actual) ? $actual : $this->format_the_html($actual);
    }
}

...
{
    protected static $transients = ['wp_rocket_pricing', 'wp_rocket_pricing_timeout', 'wp_rocket_pricing_timeout_active'];
    private $response;
    ...
    public function testShouldReturnExpected($config, $expected)
    {
        ...
        if (false !== $config['timeout-duration']) {
            $this->assertEquals($expected['timeout-duration'], get_transient('wp_rocket_pricing_timeout'));
        }
    }

...
```bash
EXISTING=$(gh pr view <PR_number> --repo wp-media/wp-rocket --json comments --jq '[.comments[] | select(.body | contains("Generated by the AI delivery pipeline"))] | last | .url // empty')
```

...
```markdown
> [!NOTE]
> Generated by the AI delivery pipeline (orchestrator · Claude Sonnet 4.6).
...
| DOD L2 | ✅ PASS | — |
| Lead Review | ✅ Approved | details on PR #<M> |
| CI | ✅ All Pass | — |
| QA | ✅ PASS | <N>/<total> criteria — details on PR #<M> |

**Follow-up tickets:** [list with links, or "None"]

**Open questions:** [resolved assumptions, or "None"]
```
